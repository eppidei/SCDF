...
int LIBUSB_CALL libusb_open_with_fd(libusb_device *dev, libusb_device_handle **handle,int fd); // for android
...
libusb_device_handle * LIBUSB_CALL libusb_open_device_with_vid_pid_and_fd(
	libusb_context *ctx, uint16_t vendor_id, uint16_t product_id, int fd); // for android
