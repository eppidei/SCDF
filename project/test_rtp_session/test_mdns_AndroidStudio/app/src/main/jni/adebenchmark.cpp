...
#include "../../../../../../../project/test_rtp_session/test_mdsn/mDNSResponder-576.30.4/mDNSCore/mDNSEmbeddedAPI.h" // Defines the interface to the client layer above
#include "../../../../../../../project/test_rtp_session/test_mdsn/mDNSResponder-576.30.4/mDNSPosix/mDNSPosix.h"      // Defines the specific types needed to run mDNS on this platform
#include "../../../../../../../project/test_rtp_session/test_mdsn/mDNSResponder-576.30.4/mDNSPosix/mDNSUNP.h"        // For daemon()
...
int TestmDNS()//(int argc, char **argv)
{
    mStatus status;
    int result;


    gServiceName="AugMIDIAndroid";
...
JNIEXPORT void JNICALL Java_main_java_ade_benchmark_BenchmarkActivity_NativeTestmDNS(JNIEnv *e, jobject o)
{
	TestmDNS();
}
